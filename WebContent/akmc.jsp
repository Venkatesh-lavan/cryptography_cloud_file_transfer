	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="akmc.jsp" accesskey="3" title="">Key Request</a></li>
	...
	<div id="header-featured" style="padding-top: 70px;" >
		<div id="banner-wrapper">
			<div id="banner" class="container">
				<h2>Keys for Files</h2></div>
				<%
				String sql = "select * from keyreceived";
				List<String> lt = Dao.getKey(sql);
				Iterator<String> itr = lt.iterator();
				%>
				<table class="w3-table w3-text-white" style="width: 950px; margin-left: 100px;">
