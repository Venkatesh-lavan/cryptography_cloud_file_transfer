	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="kmc.jsp" accesskey="3" title="">KMC</a></li>
				<li><a href="user.jsp" accesskey="4" title="">User</a></li>
	...
	<div id="header-featured" style="padding-top: 70px;">
		<div id="banner-wrapper">
			<div id="banner" class="container">
				<h2>Login</h2>
				<form action="KMC" method="post">
				<div>
				<table class="table" style="width: 650px; margin-left: 20%; margin-right: 25%;">
				<tr><td>UserId</td><td><input type="text" name="uid" class="w3-input"/> </td></tr>
