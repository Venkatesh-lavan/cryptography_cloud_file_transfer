	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="keyrequest.jsp" accesskey="4" title="">Key Requests</a></li>
	...
	<div id="header-featured" style="padding-top: 70px;">
		<div id="banner-wrapper">
			...
			<% session = request.getSession(false); 
				...
				if(b == true){
				sql = "select filename, from1, date1 from keyrequest where userid='"+name+"' and status='pending'";
				List<String> lt = Dao.getRequest(sql);
				Iterator<String> itr = lt.iterator();
			%>
				<h2>Files</h2>
				<table class="table" style="width: 850px; ">
				<tr><th>File Name</th><th>From</th><th>Date1</th><th>Approve</th></tr>
				<%
				while(itr.hasNext()){
					...
					String da = itr.next();
				%>
				<tr><td><%=fname %></td><td><%=from %></td><td><%=da %></td>
				<td><a href="UApprove?da=<%=da %>&&from=<%=from %>" class="w3-button">Approve</a></td></tr>
				<%} 
				%>
				</table>
				<%
